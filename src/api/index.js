...
export const postShortLinkGen = res => post('/api/v1/user/shortLink/gen', res)
...
export const postUserAccountUploadV2 = res => post('/api/v1/account/uploadV2', res)
export const getUserTiktokUser = res => get('/api/v1/user/tiktokUser/clean', res)
export const putUserTaskRefresh = res => put('/api/v1/user/task/' + res + '/refresh')
export const avatarUpload = res => post('/api/v1/user/accountInfo/avatarUpload', res)
export const getUserTaskDetail = res => get('/api/v1/user/taskDetail/', res)
export const getUserTaskDetailDel = res => post('/api/v1/user/tiktokUser/delete', res)
...
export const getReview = res => get('/api/v1/review/user/', res)
...
export const delAdminResource = res => deletefn('/api/v1/admin/resource/' + res, '')
export const getAdminPublish = res => get('/api/v1/admin/publish', res)
export const postAdminPublish = res => post('/api/v1/admin/publish', res)
...
export const getDealerToken = res => get('/api/v1/dealer/account/token', res)



// 聊天
export const getChatRoom = res => get('/api/v1/im/account/', res)
// 获取粉丝列表
export const getFansList = res => get('/api/v1/im/accountFollower', res)


// 获取粉丝聊天记录
export const getFansMessge = res => get('/api/v1/im/message/', res)
...
// 会计页面
// 代理信息
export const getAccountingAgentLevel = res => get('/api/v1/accounting/agentLevel/', res)
// 套餐信息 代理商
export const getAccountingComboAgent = res => get('/api/v1/accounting/comboAgent/', res)
// 套餐信息 代理商下级
export const getAccountingComboAgentUpdate = res => get('/api/v1/accounting/comboAgentUpdate/', res)
// 套餐信息 用户
export const getAccountingComboUser = res => get('/api/v1/accounting/comboUser/', res)
// 价格信息
export const getAccountingConfig = res => get('/api/v1/accounting/config/' + res)
// 支付信息 支付渠道
export const getAccountingReceivePaymentChannel = res => get('/api/v1/accounting/receivePaymentChannel/', res)
