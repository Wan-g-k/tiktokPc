    ...
    <div class="search-box">
      <a-form layout="inline" :model="searchData" class="demo-form-inline">
        ...
        <a-form-item label="昵称">
          <a-input v-model="searchData._like_r_nickname" placeholder="昵称" allow-clear />
        </a-form-item>
        <a-form-item>
        <a-form-item v-if="role == 1" label="状态">
          ...
          <a-button v-if="role == 1" type="primary" style="margin-left: 10px" @click="changeNickname">修改昵称</a-button>
          <a-button v-if="role == 1" type="primary" style="margin-left: 10px" @click="changeSignature">修改个签</a-button>
          <a-button v-if="role == 1" type="primary" style="margin-left: 10px" @click="changeHeadImg">修改头像</a-button>
...
/* {
  ...
  width: '90px',
  align: 'center',
  scopedSlots: { customRender: 'proxy_id' }
}, */
{
  title: '账号状态',
  dataIndex: 'proxy_id',
